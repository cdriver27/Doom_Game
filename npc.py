...
class NPC(AnimatedSprite):
    ...
    # animate death that only runs once
    ...
    # start animation if npc is alive
    def run_logic(self):
        if self.alive:
            ...
            if self.pain:
                ...
                # need to add playuer search trigger because npc forgets player when he is behind a wall
    ...
    def ray_cast_player_npc(self):
        ...
        if 0 < player_dist < wall_dist or wall_dist == 0:
            return True
        return False
